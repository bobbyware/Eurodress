...
namespace Nop.Plugin.BrainStation.QuickView
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("Nop.Plugin.BrainStation.QuickView.ProductDetails", "product_details/{id}",
                new { controller = "BsQuickView", action = "ProductDetails", id = UrlParameter.Optional },
